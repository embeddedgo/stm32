...
const (
	...
	CTXPKT     OTG_HS_GUSBCFG = 0x01 << 31 //+ Corrupt Tx packet
)
...
const (
	...
	DMAREQ  OTG_HS_GRSTCTL = 0x01 << 30 //+ DMA request signal
...
const (
	...
	EPMISM          OTG_HS_GINTMSK = 0x01 << 17 //+ Endpoint mismatch interrupt mask
...
const (
	...
	I2CPADEN   OTG_HS_GCCFG = 0x01 << 17 //+ Enable I2C bus connection for the external I2C PHY interface
	VBUSASEN   OTG_HS_GCCFG = 0x01 << 18 //+ Enable the VBUS sensing device
	VBUSBSEN   OTG_HS_GCCFG = 0x01 << 19 //+ Enable the VBUS sensing device
	SOFOUTEN   OTG_HS_GCCFG = 0x01 << 20 //+ SOF output enable
	NOVBUSSENS OTG_HS_GCCFG = 0x01 << 21 //+ VBUS sensing disable option
)

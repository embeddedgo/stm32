...
// Package otg_hs_device provides access to the registers of the OTG1_HS_DEVICE peripheral.
//
// Instances:
//  OTG1_HS_DEVICE  OTG1_HS_DEVICE_BASE  -  -  USB 1 on the go high speed
//  OTG2_HS_DEVICE  OTG2_HS_DEVICE_BASE  -  -  USB 1 on the go high speed
// Registers:
...
//  0x1A0 32  OTG_HS_DIEPTSIZ6    OTG_HS device endpoint transfer size register
//  0x1A4 32  OTG_HS_DTXFSTS6     OTG_HS device IN endpoint transmit FIFO status register
//  0x1A8 32  OTG_HS_DIEPTSIZ7    OTG_HS device endpoint transfer size register
//  0x1A8 32  OTG_HS_DIEPINT5     OTG device endpoint-5 interrupt register
//  0x1AC 32  OTG_HS_DTXFSTS7     OTG_HS device IN endpoint transmit FIFO status register
...
//  0x310 32  OTG_HS_DOEPTSIZ0    OTG_HS device endpoint-0 transfer size register
...
//  0x330 32  OTG_HS_DOEPTSIZ1    OTG_HS device endpoint-1 transfer size register
...
//  0x350 32  OTG_HS_DOEPTSIZ2    OTG_HS device endpoint-2 transfer size register
...
//  0x370 32  OTG_HS_DOEPTSIZ3    OTG_HS device endpoint-3 transfer size register
//  0x380 32  OTG_HS_DOEPCTL4     OTG device endpoint-4 control register
//  0x388 32  OTG_HS_DOEPINT4     OTG_HS device endpoint-4 interrupt register
//  0x390 32  OTG_HS_DOEPTSIZ4    OTG_HS device endpoint-4 transfer size register
//  0x3A0 32  OTG_HS_DOEPCTL5     OTG device endpoint-5 control register
//  0x3A8 32  OTG_HS_DOEPINT5     OTG_HS device endpoint-5 interrupt register
//  0x3B0 32  OTG_HS_DOEPTSIZ5    OTG_HS device endpoint-5 transfer size register
//  0x3C0 32  OTG_HS_DOEPCTL6     OTG device endpoint-6 control register
//  0x3C8 32  OTG_HS_DOEPINT6     OTG_HS device endpoint-6 interrupt register
//  0x3D0 32  OTG_HS_DOEPTSIZ6    OTG_HS device endpoint-6 transfer size register
//  0x3E0 32  OTG_HS_DOEPCTL7     OTG device endpoint-7 control register
//  0x3E8 32  OTG_HS_DOEPINT7     OTG_HS device endpoint-7 interrupt register
//  0x3F0 32  OTG_HS_DOEPTSIZ7    OTG_HS device endpoint-7 transfer size register
// Import:
...
const (
	XFRSIZ OTG_HS_DIEPTSIZ6 = 0x7FFFF << 0 //+ Transfer size
	PKTCNT OTG_HS_DIEPTSIZ6 = 0x3FF << 19  //+ Packet count
	MCNT   OTG_HS_DIEPTSIZ6 = 0x03 << 29   //+ Multi count
)
...
const (
	INEPTFSAV OTG_HS_DTXFSTS6 = 0xFFFF << 0 //+ IN endpoint TxFIFO space avail
)
...
const (
	XFRSIZ OTG_HS_DIEPTSIZ7 = 0x7FFFF << 0 //+ Transfer size
	PKTCNT OTG_HS_DIEPTSIZ7 = 0x3FF << 19  //+ Packet count
	MCNT   OTG_HS_DIEPTSIZ7 = 0x03 << 29   //+ Multi count
)
...
const (
	INEPTFSAV OTG_HS_DTXFSTS7 = 0xFFFF << 0 //+ IN endpoint TxFIFO space avail
)
...
const (
	MPSIZ          OTG_HS_DOEPCTL4 = 0x7FF << 0 //+ Maximum packet size
	USBAEP         OTG_HS_DOEPCTL4 = 0x01 << 15 //+ USB active endpoint
	EONUM_DPID     OTG_HS_DOEPCTL4 = 0x01 << 16 //+ Even odd frame/Endpoint data PID
	NAKSTS         OTG_HS_DOEPCTL4 = 0x01 << 17 //+ NAK status
	EPTYP          OTG_HS_DOEPCTL4 = 0x03 << 18 //+ Endpoint type
	SNPM           OTG_HS_DOEPCTL4 = 0x01 << 20 //+ Snoop mode
	Stall          OTG_HS_DOEPCTL4 = 0x01 << 21 //+ STALL handshake
	CNAK           OTG_HS_DOEPCTL4 = 0x01 << 26 //+ Clear NAK
	SNAK           OTG_HS_DOEPCTL4 = 0x01 << 27 //+ Set NAK
	SD0PID_SEVNFRM OTG_HS_DOEPCTL4 = 0x01 << 28 //+ Set DATA0 PID/Set even frame
	SODDFRM        OTG_HS_DOEPCTL4 = 0x01 << 29 //+ Set odd frame
	EPDIS          OTG_HS_DOEPCTL4 = 0x01 << 30 //+ Endpoint disable
	EPENA          OTG_HS_DOEPCTL4 = 0x01 << 31 //+ Endpoint enable
)
...
const (
	MPSIZ          OTG_HS_DOEPCTL5 = 0x7FF << 0 //+ Maximum packet size
	USBAEP         OTG_HS_DOEPCTL5 = 0x01 << 15 //+ USB active endpoint
	EONUM_DPID     OTG_HS_DOEPCTL5 = 0x01 << 16 //+ Even odd frame/Endpoint data PID
	NAKSTS         OTG_HS_DOEPCTL5 = 0x01 << 17 //+ NAK status
	EPTYP          OTG_HS_DOEPCTL5 = 0x03 << 18 //+ Endpoint type
	SNPM           OTG_HS_DOEPCTL5 = 0x01 << 20 //+ Snoop mode
	Stall          OTG_HS_DOEPCTL5 = 0x01 << 21 //+ STALL handshake
	CNAK           OTG_HS_DOEPCTL5 = 0x01 << 26 //+ Clear NAK
	SNAK           OTG_HS_DOEPCTL5 = 0x01 << 27 //+ Set NAK
	SD0PID_SEVNFRM OTG_HS_DOEPCTL5 = 0x01 << 28 //+ Set DATA0 PID/Set even frame
	SODDFRM        OTG_HS_DOEPCTL5 = 0x01 << 29 //+ Set odd frame
	EPDIS          OTG_HS_DOEPCTL5 = 0x01 << 30 //+ Endpoint disable
	EPENA          OTG_HS_DOEPCTL5 = 0x01 << 31 //+ Endpoint enable
)
...
const (
	XFRSIZ         OTG_HS_DOEPTSIZ5 = 0x7FFFF << 0 //+ Transfer size
	PKTCNT         OTG_HS_DOEPTSIZ5 = 0x3FF << 19  //+ Packet count
	RXDPID_STUPCNT OTG_HS_DOEPTSIZ5 = 0x03 << 29   //+ Received data PID/SETUP packet count
)
...
const (
	MPSIZ          OTG_HS_DOEPCTL6 = 0x7FF << 0 //+ Maximum packet size
	USBAEP         OTG_HS_DOEPCTL6 = 0x01 << 15 //+ USB active endpoint
	EONUM_DPID     OTG_HS_DOEPCTL6 = 0x01 << 16 //+ Even odd frame/Endpoint data PID
	NAKSTS         OTG_HS_DOEPCTL6 = 0x01 << 17 //+ NAK status
	EPTYP          OTG_HS_DOEPCTL6 = 0x03 << 18 //+ Endpoint type
	SNPM           OTG_HS_DOEPCTL6 = 0x01 << 20 //+ Snoop mode
	Stall          OTG_HS_DOEPCTL6 = 0x01 << 21 //+ STALL handshake
	CNAK           OTG_HS_DOEPCTL6 = 0x01 << 26 //+ Clear NAK
	SNAK           OTG_HS_DOEPCTL6 = 0x01 << 27 //+ Set NAK
	SD0PID_SEVNFRM OTG_HS_DOEPCTL6 = 0x01 << 28 //+ Set DATA0 PID/Set even frame
	SODDFRM        OTG_HS_DOEPCTL6 = 0x01 << 29 //+ Set odd frame
	EPDIS          OTG_HS_DOEPCTL6 = 0x01 << 30 //+ Endpoint disable
	EPENA          OTG_HS_DOEPCTL6 = 0x01 << 31 //+ Endpoint enable
)
...
const (
	XFRSIZ         OTG_HS_DOEPTSIZ6 = 0x7FFFF << 0 //+ Transfer size
	PKTCNT         OTG_HS_DOEPTSIZ6 = 0x3FF << 19  //+ Packet count
	RXDPID_STUPCNT OTG_HS_DOEPTSIZ6 = 0x03 << 29   //+ Received data PID/SETUP packet count
)
...
const (
	MPSIZ          OTG_HS_DOEPCTL7 = 0x7FF << 0 //+ Maximum packet size
	USBAEP         OTG_HS_DOEPCTL7 = 0x01 << 15 //+ USB active endpoint
	EONUM_DPID     OTG_HS_DOEPCTL7 = 0x01 << 16 //+ Even odd frame/Endpoint data PID
	NAKSTS         OTG_HS_DOEPCTL7 = 0x01 << 17 //+ NAK status
	EPTYP          OTG_HS_DOEPCTL7 = 0x03 << 18 //+ Endpoint type
	SNPM           OTG_HS_DOEPCTL7 = 0x01 << 20 //+ Snoop mode
	Stall          OTG_HS_DOEPCTL7 = 0x01 << 21 //+ STALL handshake
	CNAK           OTG_HS_DOEPCTL7 = 0x01 << 26 //+ Clear NAK
	SNAK           OTG_HS_DOEPCTL7 = 0x01 << 27 //+ Set NAK
	SD0PID_SEVNFRM OTG_HS_DOEPCTL7 = 0x01 << 28 //+ Set DATA0 PID/Set even frame
	SODDFRM        OTG_HS_DOEPCTL7 = 0x01 << 29 //+ Set odd frame
	EPDIS          OTG_HS_DOEPCTL7 = 0x01 << 30 //+ Endpoint disable
	EPENA          OTG_HS_DOEPCTL7 = 0x01 << 31 //+ Endpoint enable
)
...
const (
	XFRSIZ         OTG_HS_DOEPTSIZ7 = 0x7FFFF << 0 //+ Transfer size
	PKTCNT         OTG_HS_DOEPTSIZ7 = 0x3FF << 19  //+ Packet count
	RXDPID_STUPCNT OTG_HS_DOEPTSIZ7 = 0x03 << 29   //+ Received data PID/SETUP packet count
)

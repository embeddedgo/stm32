...
func PVME1_(p *Periph) mmio.RM32[CR2] { return mmio.RM32[CR2]{R: &p.CR2, Mask: PVME1} }
func PVME2_(p *Periph) mmio.RM32[CR2] { return mmio.RM32[CR2]{R: &p.CR2, Mask: PVME2} }
func PVME3_(p *Periph) mmio.RM32[CR2] { return mmio.RM32[CR2]{R: &p.CR2, Mask: PVME3} }
func PVME4_(p *Periph) mmio.RM32[CR2] { return mmio.RM32[CR2]{R: &p.CR2, Mask: PVME4} }
func IOSV_(p *Periph) mmio.RM32[CR2]  { return mmio.RM32[CR2]{R: &p.CR2, Mask: IOSV} }
func USV_(p *Periph) mmio.RM32[CR2]   { return mmio.RM32[CR2]{R: &p.CR2, Mask: USV} }
...
func EWF_(p *Periph) mmio.RM32[CR3]   { return mmio.RM32[CR3]{R: &p.CR3, Mask: EWF} }
...
func CWUF1_(p *Periph) mmio.RM32[SR1] { return mmio.RM32[SR1]{R: &p.SR1, Mask: CWUF1} }
func CWUF2_(p *Periph) mmio.RM32[SR1] { return mmio.RM32[SR1]{R: &p.SR1, Mask: CWUF2} }
func CWUF3_(p *Periph) mmio.RM32[SR1] { return mmio.RM32[SR1]{R: &p.SR1, Mask: CWUF3} }
func CWUF4_(p *Periph) mmio.RM32[SR1] { return mmio.RM32[SR1]{R: &p.SR1, Mask: CWUF4} }
func CWUF5_(p *Periph) mmio.RM32[SR1] { return mmio.RM32[SR1]{R: &p.SR1, Mask: CWUF5} }
func CSBF_(p *Periph) mmio.RM32[SR1]  { return mmio.RM32[SR1]{R: &p.SR1, Mask: CSBF} }
...
func WUF1_(p *Periph) mmio.RM32[SCR] { return mmio.RM32[SCR]{R: &p.SCR, Mask: WUF1} }
func WUF2_(p *Periph) mmio.RM32[SCR] { return mmio.RM32[SCR]{R: &p.SCR, Mask: WUF2} }
func WUF3_(p *Periph) mmio.RM32[SCR] { return mmio.RM32[SCR]{R: &p.SCR, Mask: WUF3} }
func WUF4_(p *Periph) mmio.RM32[SCR] { return mmio.RM32[SCR]{R: &p.SCR, Mask: WUF4} }
func WUF5_(p *Periph) mmio.RM32[SCR] { return mmio.RM32[SCR]{R: &p.SCR, Mask: WUF5} }
func SBF_(p *Periph) mmio.RM32[SCR]  { return mmio.RM32[SCR]{R: &p.SCR, Mask: SBF} }
...
func PU14_(p *Periph, i int) mmio.RM32[PUCR] { return mmio.RM32[PUCR]{R: &p.PUDC[i].PUCR, Mask: PU14} }
...
func PD13_(p *Periph, i int) mmio.RM32[PDCR] { return mmio.RM32[PDCR]{R: &p.PUDC[i].PDCR, Mask: PD13} }
func PD14_(p *Periph, i int) mmio.RM32[PDCR] { return mmio.RM32[PDCR]{R: &p.PUDC[i].PDCR, Mask: PD14} }
func PD15_(p *Periph, i int) mmio.RM32[PDCR] { return mmio.RM32[PDCR]{R: &p.PUDC[i].PDCR, Mask: PD15} }

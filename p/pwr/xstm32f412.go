...
func ADCDC1_(p *Periph) mmio.RM32[CR] { return mmio.RM32[CR]{&p.CR, ADCDC1} }
func VOS_(p *Periph) mmio.RM32[CR]    { return mmio.RM32[CR]{&p.CR, VOS} }
...
func VOSRDY_(p *Periph) mmio.RM32[CSR] { return mmio.RM32[CSR]{&p.CSR, VOSRDY} }

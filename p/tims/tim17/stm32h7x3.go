...
const (
	BKINE    TIM17_AF1 = 0x01 << 0  //+ BRK BKIN input enable
	BKCMP1E  TIM17_AF1 = 0x01 << 1  //+ BRK COMP1 enable
	BKCMP2E  TIM17_AF1 = 0x01 << 2  //+ BRK COMP2 enable
	BKDFBK1E TIM17_AF1 = 0x01 << 8  //+ BRK dfsdm1_break[1] enable
	BKINP    TIM17_AF1 = 0x01 << 9  //+ BRK BKIN input polarity
	BKCMP1P  TIM17_AF1 = 0x01 << 10 //+ BRK COMP1 input polarity
	BKCMP2P  TIM17_AF1 = 0x01 << 11 //+ BRK COMP2 input polarity
)
...
const (
	TI1SEL TIM17_TISEL = 0x0F << 0 //+ selects TI1[0] to TI1[15] input
)

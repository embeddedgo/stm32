...
const (
	DCDET  FS_GCCFG = 0x01 << 0  //+ DCDET
	PDET   FS_GCCFG = 0x01 << 1  //+ PDET
	SDET   FS_GCCFG = 0x01 << 2  //+ SDET
	PS2DET FS_GCCFG = 0x01 << 3  //+ PS2DET
	PWRDWN FS_GCCFG = 0x01 << 16 //+ PWRDWN
	BCDEN  FS_GCCFG = 0x01 << 17 //+ BCDEN
	DCDEN  FS_GCCFG = 0x01 << 18 //+ DCDEN
	PDEN   FS_GCCFG = 0x01 << 19 //+ PDEN
	SDEN   FS_GCCFG = 0x01 << 20 //+ SDEN
	VBDEN  FS_GCCFG = 0x01 << 21 //+ VBDEN
)

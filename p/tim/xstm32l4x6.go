...
func ETR_ADC1_RMP_(p *Periph) mmio.RM32[OR1] { return mmio.RM32[OR1]{&p.OR1, ETR_ADC1_RMP} }
func ETR_ADC3_RMP_(p *Periph) mmio.RM32[OR1] { return mmio.RM32[OR1]{&p.OR1, ETR_ADC3_RMP} }
func TI1_RMP_(p *Periph) mmio.RM32[OR1]      { return mmio.RM32[OR1]{&p.OR1, TI1_RMP} }
...
func BKINE_(p *Periph) mmio.RM32[OR2]    { return mmio.RM32[OR2]{&p.OR2, BKINE} }
func BKCMP1E_(p *Periph) mmio.RM32[OR2]  { return mmio.RM32[OR2]{&p.OR2, BKCMP1E} }
func BKCMP2E_(p *Periph) mmio.RM32[OR2]  { return mmio.RM32[OR2]{&p.OR2, BKCMP2E} }
func BKDFBK0E_(p *Periph) mmio.RM32[OR2] { return mmio.RM32[OR2]{&p.OR2, BKDFBK0E} }
func BKINP_(p *Periph) mmio.RM32[OR2]    { return mmio.RM32[OR2]{&p.OR2, BKINP} }
func BKCMP1P_(p *Periph) mmio.RM32[OR2]  { return mmio.RM32[OR2]{&p.OR2, BKCMP1P} }
func BKCMP2P_(p *Periph) mmio.RM32[OR2]  { return mmio.RM32[OR2]{&p.OR2, BKCMP2P} }
func ETRSEL_(p *Periph) mmio.RM32[OR2]   { return mmio.RM32[OR2]{&p.OR2, ETRSEL} }

type OR3 uint32

func BK2INE_(p *Periph) mmio.RM32[OR3]    { return mmio.RM32[OR3]{&p.OR3, BK2INE} }
func BK2CMP1E_(p *Periph) mmio.RM32[OR3]  { return mmio.RM32[OR3]{&p.OR3, BK2CMP1E} }
func BK2CMP2E_(p *Periph) mmio.RM32[OR3]  { return mmio.RM32[OR3]{&p.OR3, BK2CMP2E} }
func BK2DFBK0E_(p *Periph) mmio.RM32[OR3] { return mmio.RM32[OR3]{&p.OR3, BK2DFBK0E} }
func BK2INP_(p *Periph) mmio.RM32[OR3]    { return mmio.RM32[OR3]{&p.OR3, BK2INP} }
func BK2CMP1P_(p *Periph) mmio.RM32[OR3]  { return mmio.RM32[OR3]{&p.OR3, BK2CMP1P} }
func BK2CMP2P_(p *Periph) mmio.RM32[OR3]  { return mmio.RM32[OR3]{&p.OR3, BK2CMP2P} }

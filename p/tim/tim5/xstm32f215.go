...
type RTIM5_OR struct{ mmio.U32 }

func (r *RTIM5_OR) LoadBits(mask TIM5_OR) TIM5_OR { return TIM5_OR(r.U32.LoadBits(uint32(mask))) }
func (r *RTIM5_OR) StoreBits(mask, b TIM5_OR)     { r.U32.StoreBits(uint32(mask), uint32(b)) }
func (r *RTIM5_OR) SetBits(mask TIM5_OR)          { r.U32.SetBits(uint32(mask)) }
func (r *RTIM5_OR) ClearBits(mask TIM5_OR)        { r.U32.ClearBits(uint32(mask)) }
func (r *RTIM5_OR) Load() TIM5_OR                 { return TIM5_OR(r.U32.Load()) }
func (r *RTIM5_OR) Store(b TIM5_OR)               { r.U32.Store(uint32(b)) }

type RMTIM5_OR struct{ mmio.UM32 }

func (rm RMTIM5_OR) Load() TIM5_OR   { return TIM5_OR(rm.UM32.Load()) }
func (rm RMTIM5_OR) Store(b TIM5_OR) { rm.UM32.Store(uint32(b)) }

func IT4_RMP_(p *Periph) RMTIM5_OR {
	return RMTIM5_OR{mmio.UM32{&p.TIM5_OR.U32, uint32(IT4_RMP)}}
}

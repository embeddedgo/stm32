...
//  0x054 32  CCMR3_Output  capture/compare mode register 2 (output mode)
...
const (
	ETR_ADC1_RMP OR1 = 0x03 << 0 //+ External trigger remap on ADC1 analog watchdog
	ETR_ADC3_RMP OR1 = 0x03 << 2 //+ External trigger remap on ADC3 analog watchdog
	TI1_RMP      OR1 = 0x01 << 4 //+ Input Capture 1 remap
)
...
const (
	BKINE    OR2 = 0x01 << 0  //+ BRK BKIN input enable
	BKCMP1E  OR2 = 0x01 << 1  //+ BRK COMP1 enable
	BKCMP2E  OR2 = 0x01 << 2  //+ BRK COMP2 enable
	BKDFBK0E OR2 = 0x01 << 8  //+ BRK DFSDM_BREAK0 enable
	BKINP    OR2 = 0x01 << 9  //+ BRK BKIN input polarity
	BKCMP1P  OR2 = 0x01 << 10 //+ BRK COMP1 input polarity
	BKCMP2P  OR2 = 0x01 << 11 //+ BRK COMP2 input polarity
	ETRSEL   OR2 = 0x07 << 14 //+ ETR source selection
)
...
const (
	BK2INE    OR3 = 0x01 << 0  //+ BRK2 BKIN input enable
	BK2CMP1E  OR3 = 0x01 << 1  //+ BRK2 COMP1 enable
	BK2CMP2E  OR3 = 0x01 << 2  //+ BRK2 COMP2 enable
	BK2DFBK0E OR3 = 0x01 << 8  //+ BRK2 DFSDM_BREAK0 enable
	BK2INP    OR3 = 0x01 << 9  //+ BRK2 BKIN input polarity
	BK2CMP1P  OR3 = 0x01 << 10 //+ BRK2 COMP1 input polarity
	BK2CMP2P  OR3 = 0x01 << 11 //+ BRK2 COMP2 input polarity
)

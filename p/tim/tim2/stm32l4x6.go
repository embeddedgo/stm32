...
//  0x050 32  OR            TIM2 option register
// Import:
...
const (
	...
	CNT_H CNT = 0xFFFF << 16 //+ High counter value (TIM2 only)
)
...
const (
	...
	ARR_H ARR = 0xFFFF << 16 //+ High Auto-reload value (TIM2 only)
)
...
const (
	...
	CCR1_H CCR1 = 0xFFFF << 16 //+ High Capture/Compare 1 value (TIM2 only)
)
...
const (
	...
	CCR2_H CCR2 = 0xFFFF << 16 //+ High Capture/Compare 2 value (TIM2 only)
)
...
const (
	...
	CCR3_H CCR3 = 0xFFFF << 16 //+ High Capture/Compare value (TIM2 only)
)
...
const (
	...
	CCR4_H CCR4 = 0xFFFF << 16 //+ High Capture/Compare value (TIM2 only)
)
...
const (
	ETR_RMP OR = 0x07 << 0 //+ Timer2 ETR remap
	TI4_RMP OR = 0x03 << 3 //+ Internal trigger
)

...
type RTIM2_OR struct{ mmio.U32 }

func (r *RTIM2_OR) LoadBits(mask TIM2_OR) TIM2_OR { return TIM2_OR(r.U32.LoadBits(uint32(mask))) }
func (r *RTIM2_OR) StoreBits(mask, b TIM2_OR)     { r.U32.StoreBits(uint32(mask), uint32(b)) }
func (r *RTIM2_OR) SetBits(mask TIM2_OR)          { r.U32.SetBits(uint32(mask)) }
func (r *RTIM2_OR) ClearBits(mask TIM2_OR)        { r.U32.ClearBits(uint32(mask)) }
func (r *RTIM2_OR) Load() TIM2_OR                 { return TIM2_OR(r.U32.Load()) }
func (r *RTIM2_OR) Store(b TIM2_OR)               { r.U32.Store(uint32(b)) }

type RMTIM2_OR struct{ mmio.UM32 }

func (rm RMTIM2_OR) Load() TIM2_OR   { return TIM2_OR(rm.UM32.Load()) }
func (rm RMTIM2_OR) Store(b TIM2_OR) { rm.UM32.Store(uint32(b)) }

func IT4_RMP_(p *Periph) RMTIM2_OR {
	return RMTIM2_OR{mmio.UM32{&p.TIM2_OR.U32, uint32(IT4_RMP)}}
}

...
//  0x050 32  OR1        TIM16 option register 1
//  0x060 32  OR2        TIM17 option register 1
// Import:
...
const (
	TI1_RMP OR1 = 0x03 << 0 //+ Input capture 1 remap
)
...
const (
	...
	BKDFBK1E OR2 = 0x01 << 8  //+ BRK DFSDM_BREAK1 enable
	BKINP    OR2 = 0x01 << 9  //+ BRK BKIN input polarity
	BKCMP1P  OR2 = 0x01 << 10 //+ BRK COMP1 input polarity
	BKCMP2P  OR2 = 0x01 << 11 //+ BRK COMP2 input polarit
)

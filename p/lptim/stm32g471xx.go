...
const (
	...
	TRIGSEL   CFGR = 0x0F << 13 //+ Trigger selector
...
const (
	...
	COUNTRST CR = 0x01 << 3 //+ COUNTRST
	RSTARE   CR = 0x01 << 4 //+ RSTARE
)
...
const (
	IN1     OR = 0x01 << 0 //+ IN1
	IN2     OR = 0x01 << 1 //+ IN2
	IN1_2_1 OR = 0x03 << 2 //+ IN1_2_1
	IN2_2_1 OR = 0x03 << 4 //+ IN2_2_1
)

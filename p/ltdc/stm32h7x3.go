...
const (
	...
	AHBP BPCR = 0xFFF << 16 //+ Accumulated Horizontal back porch (in units of pixel clock period)
)
...
const (
	...
	TOTALW TWCR = 0xFFF << 16 //+ Total Width (in units of pixel clock period)
)
...
const (
	BCBLUE  BCCR = 0xFF << 0  //+ Background Color Blue value
	BCGREEN BCCR = 0xFF << 8  //+ Background Color Green value
	BCRED   BCCR = 0xFF << 16 //+ Background Color Red value
)
...
const (
	...
	CKGREEN L2CKCR = 0xFF << 8  //+ Color Key Green value
	CKRED   L2CKCR = 0xFF << 16 //+ Color Key Red value
)

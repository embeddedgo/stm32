...
const (
	IACCVIOL    CFSR_UFSR_BFSR_MMFSR = 0x01 << 0  //+ IACCVIOL
	DACCVIOL    CFSR_UFSR_BFSR_MMFSR = 0x01 << 1  //+ DACCVIOL
	MUNSTKERR   CFSR_UFSR_BFSR_MMFSR = 0x01 << 3  //+ MUNSTKERR
	MSTKERR     CFSR_UFSR_BFSR_MMFSR = 0x01 << 4  //+ MSTKERR
	MLSPERR     CFSR_UFSR_BFSR_MMFSR = 0x01 << 5  //+ MLSPERR
	MMARVALID   CFSR_UFSR_BFSR_MMFSR = 0x01 << 7  //+ MMARVALID
...
const (
	ADDRESS MMFAR = 0xFFFFFFFF << 0 //+ Memory management fault address
)
...
const (
	ADDRESS BFAR = 0xFFFFFFFF << 0 //+ Bus fault address
)

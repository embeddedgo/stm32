...
const (
	ATTSETx  PATT2 = 0xFF << 0  //+ Attribute memory x setup time
	ATTWAITx PATT2 = 0xFF << 8  //+ Attribute memory x wait time
	ATTHOLDx PATT2 = 0xFF << 16 //+ Attribute memory x hold time
	ATTHIZx  PATT2 = 0xFF << 24 //+ Attribute memory x databus HiZ time
)
...
const (
	ECCx ECCR2 = 0xFFFFFFFF << 0 //+ ECC result
)

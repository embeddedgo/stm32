...
const (
	SLVEN    CR2 = 0x01 << 0  //+ SLVEN
	DIS_NSS  CR2 = 0x01 << 3  //+ DIS_NSS
...
const (
	DIV_Fraction BRR = 0x0F << 0  //+ DIV_Fraction
	DIV_Mantissa BRR = 0xFFF << 4 //+ DIV_Mantissa
)
...
const (
	...
	TXFECF  ICR = 0x01 << 5  //+ TXFECF
	TCCF    ICR = 0x01 << 6  //+ Transmission complete clear flag
	TCBGTCF ICR = 0x01 << 7  //+ TCBGTCF

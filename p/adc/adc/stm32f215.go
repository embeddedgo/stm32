...
const (
	SMP10 SMPR1 = 0x07 << 0  //+ Channel 10 sampling time selection
	SMP11 SMPR1 = 0x07 << 3  //+ Channel 11 sampling time selection
	SMP12 SMPR1 = 0x07 << 6  //+ Channel 12 sampling time selection
	SMP13 SMPR1 = 0x07 << 9  //+ Channel 13 sampling time selection
	SMP14 SMPR1 = 0x07 << 12 //+ Channel 14 sampling time selection
	SMP15 SMPR1 = 0x07 << 15 //+ Channel 15 sampling time selection
	SMP16 SMPR1 = 0x07 << 18 //+ Channel 16 sampling time selection
	SMP17 SMPR1 = 0x07 << 21 //+ Channel 17 sampling time selection
	SMP18 SMPR1 = 0x07 << 24 //+ Channel 18 sampling time selection
)
...
const (
	SMP0 SMPR2 = 0x07 << 0  //+ Channel 0 sampling time selection
	SMP1 SMPR2 = 0x07 << 3  //+ Channel 1 sampling time selection
	SMP2 SMPR2 = 0x07 << 6  //+ Channel 2 sampling time selection
	SMP3 SMPR2 = 0x07 << 9  //+ Channel 3 sampling time selection
	SMP4 SMPR2 = 0x07 << 12 //+ Channel 4 sampling time selection
	SMP5 SMPR2 = 0x07 << 15 //+ Channel 5 sampling time selection
	SMP6 SMPR2 = 0x07 << 18 //+ Channel 6 sampling time selection
	SMP7 SMPR2 = 0x07 << 21 //+ Channel 7 sampling time selection
	SMP8 SMPR2 = 0x07 << 24 //+ Channel 8 sampling time selection
	SMP9 SMPR2 = 0x07 << 27 //+ Channel 9 sampling time selection
)

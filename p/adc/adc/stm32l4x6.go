...
//  ADC2  ADC2_BASE  -  ADC1_2+,ADC3+  Analog-to-Digital Converter
//  ADC3  ADC3_BASE  -  ADC1_2+,ADC3+  Analog-to-Digital Converter
// Registers:
...
const (
	...
	DFSDMCFG CFGR = 0x01 << 2  //+ DFSDMCFG
	RES      CFGR = 0x03 << 3  //+ RES
	ALIGN    CFGR = 0x01 << 5  //+ ALIGN
...
const (
	JL      JSQR = 0x03 << 0  //+ JL
	JEXTSEL JSQR = 0x0F << 2  //+ JEXTSEL
	JEXTEN  JSQR = 0x03 << 6  //+ JEXTEN
	JSQ1    JSQR = 0x1F << 8  //+ JSQ1
	JSQ2    JSQR = 0x1F << 14 //+ JSQ2
	JSQ3    JSQR = 0x1F << 20 //+ JSQ3
	JSQ4    JSQR = 0x1F << 26 //+ JSQ4
)
...
const (
	OFFSET2    OFR2 = 0xFFF << 0 //+ OFFSET2
	OFFSET2_CH OFR2 = 0x1F << 26 //+ OFFSET2_CH
	OFFSET2_EN OFR2 = 0x01 << 31 //+ OFFSET2_EN
)
...
const (
	OFFSET3    OFR3 = 0xFFF << 0 //+ OFFSET3
	OFFSET3_CH OFR3 = 0x1F << 26 //+ OFFSET3_CH
	OFFSET3_EN OFR3 = 0x01 << 31 //+ OFFSET3_EN
)
...
const (
	OFFSET4    OFR4 = 0xFFF << 0 //+ OFFSET4
	OFFSET4_CH OFR4 = 0x1F << 26 //+ OFFSET4_CH
	OFFSET4_EN OFR4 = 0x01 << 31 //+ OFFSET4_EN
)
...
const (
	...
	DIFSEL_1_15  DIFSEL = 0x7FFF << 1 //+ Differential mode for channels 15 to 1
	DIFSEL_16_18 DIFSEL = 0x07 << 16  //+ Differential mode for channels 18 to 16
)

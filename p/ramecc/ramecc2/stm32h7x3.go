...
// Package ramecc2 provides access to the registers of the RAMECC peripheral.
//
// Instances:
//
//	RAMECC2  RAMECC2_BASE  -  -  ECC controller is associated to each RAM area
//
// Registers:
//
...
const (
	ECCSEIE   M3CR = 0x01 << 2 //+ ECC single error interrupt enable
	ECCDEIE   M3CR = 0x01 << 3 //+ ECC double error interrupt enable
	ECCDEBWIE M3CR = 0x01 << 4 //+ ECC double error on byte write (BW) interrupt enable
	ECCELEN   M3CR = 0x01 << 5 //+ ECC error latching enable
)
...
const (
	SEDCF  M3SR = 0x01 << 0 //+ ECC single error detected and corrected flag
	DEDF   M3SR = 0x01 << 1 //+ ECC double error detected flag
	DEBWDF M3SR = 0x01 << 2 //+ ECC double error on byte write (BW) detected flag
)
...
const (
	FDATAH M3FDRH = 0xFFFFFFFF << 0 //+ Failing data high (64-bit memory)
)
...
const (
	FEC M3FECR = 0xFFFFFFFF << 0 //+ Failing error code
)
...
const (
	ECCSEIE   M4CR = 0x01 << 2 //+ ECC single error interrupt enable
	ECCDEIE   M4CR = 0x01 << 3 //+ ECC double error interrupt enable
	ECCDEBWIE M4CR = 0x01 << 4 //+ ECC double error on byte write (BW) interrupt enable
	ECCELEN   M4CR = 0x01 << 5 //+ ECC error latching enable
)
...
const (
	SEDCF  M4SR = 0x01 << 0 //+ ECC single error detected and corrected flag
	DEDF   M4SR = 0x01 << 1 //+ ECC double error detected flag
	DEBWDF M4SR = 0x01 << 2 //+ ECC double error on byte write (BW) detected flag
)
...
const (
	FADD M4FAR = 0xFFFFFFFF << 0 //+ ECC error failing address
)
...
const (
	FDATAL M4FDRL = 0xFFFFFFFF << 0 //+ Failing data low
)
...
const (
	FEC M4FECR = 0xFFFFFFFF << 0 //+ Failing error code
)
...
const (
	ECCSEIE   M5CR = 0x01 << 2 //+ ECC single error interrupt enable
	ECCDEIE   M5CR = 0x01 << 3 //+ ECC double error interrupt enable
	ECCDEBWIE M5CR = 0x01 << 4 //+ ECC double error on byte write (BW) interrupt enable
	ECCELEN   M5CR = 0x01 << 5 //+ ECC error latching enable
)
...
const (
	SEDCF  M5SR = 0x01 << 0 //+ ECC single error detected and corrected flag
	DEDF   M5SR = 0x01 << 1 //+ ECC double error detected flag
	DEBWDF M5SR = 0x01 << 2 //+ ECC double error on byte write (BW) detected flag
)
...
const (
	FADD M5FAR = 0xFFFFFFFF << 0 //+ ECC error failing address
)
...
const (
	FDATAL M5FDRL = 0xFFFFFFFF << 0 //+ Failing data low
)

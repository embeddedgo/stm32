...
//	GPIOH  GPIOH_BASE  AHB2  -  General-purpose I/Os
//	GPIOI  GPIOI_BASE  AHB2  -  General-purpose I/Os
//
// Registers:
//
...
//	0x02C 32  ASCR     GPIO port analog switch control register
//
// Import:
//
...
const (
	ASC0  ASCR = 0x01 << 0  //+ Port analog switch control
	ASC1  ASCR = 0x01 << 1  //+ Port analog switch control
	ASC2  ASCR = 0x01 << 2  //+ Port analog switch control
	ASC3  ASCR = 0x01 << 3  //+ Port analog switch control
	ASC4  ASCR = 0x01 << 4  //+ Port analog switch control
	ASC5  ASCR = 0x01 << 5  //+ Port analog switch control
	ASC6  ASCR = 0x01 << 6  //+ Port analog switch control
	ASC7  ASCR = 0x01 << 7  //+ Port analog switch control
	ASC8  ASCR = 0x01 << 8  //+ Port analog switch control
	ASC9  ASCR = 0x01 << 9  //+ Port analog switch control
	ASC10 ASCR = 0x01 << 10 //+ Port analog switch control
	ASC11 ASCR = 0x01 << 11 //+ Port analog switch control
	ASC12 ASCR = 0x01 << 12 //+ Port analog switch control
	ASC13 ASCR = 0x01 << 13 //+ Port analog switch control
	ASC14 ASCR = 0x01 << 14 //+ Port analog switch control
	ASC15 ASCR = 0x01 << 15 //+ Port analog switch control
)

...
//
// Instances:
//  SWPMI  SWPMI_BASE  -  -  Single Wire Protocol Master Interface
// Registers:
...
const (
	...
	SWPTEN CR = 0x01 << 11 //+ Single wire protocol master transceiver enable
)
...
const (
	BR BRR = 0xFF << 0 //+ Bitrate prescaler
)
...
const (
	...
	RDYF   ISR = 0x01 << 11 //+ transceiver ready flag
)
...
const (
	...
	CRDYF   ICR = 0x01 << 11 //+ Clear transceiver ready flag
)
...
const (
	...
	RDYIE   IER = 0x01 << 11 //+ Transceiver ready interrupt enable
)

...
func (p *Periph) GPIOIRST() RMAHB1RSTR {
...
func (p *Periph) ETHMACRST() RMAHB1RSTR {
	return RMAHB1RSTR{mmio.UM32{&p.AHB1RSTR.U32, uint32(ETHMACRST)}}
}

func (p *Periph) OTGHSRST() RMAHB1RSTR {
...
func (p *Periph) CRYPRST() RMAHB2RSTR {
	return RMAHB2RSTR{mmio.UM32{&p.AHB2RSTR.U32, uint32(CRYPRST)}}
}

func (p *Periph) HSAHRST() RMAHB2RSTR {
	return RMAHB2RSTR{mmio.UM32{&p.AHB2RSTR.U32, uint32(HSAHRST)}}
}
...
func (p *Periph) FSMCRST() RMAHB3RSTR {
...
func (p *Periph) DACRST() RMAPB1RSTR {
...
func (p *Periph) GPIOIEN() RMAHB1ENR {
...
func (p *Periph) BKPSRAMEN() RMAHB1ENR {
...
func (p *Periph) CRYPEN() RMAHB2ENR {
...
func (p *Periph) FSMCEN() RMAHB3ENR {
...
func (p *Periph) UART4EN() RMAPB1ENR {
	return RMAPB1ENR{mmio.UM32{&p.APB1ENR.U32, uint32(UART4EN)}}
}

func (p *Periph) UART5EN() RMAPB1ENR {
...
func (p *Periph) ADC2EN() RMAPB2ENR {
	return RMAPB2ENR{mmio.UM32{&p.APB2ENR.U32, uint32(ADC2EN)}}
}

func (p *Periph) ADC3EN() RMAPB2ENR {
...
func (p *Periph) GPIOILPEN() RMAHB1LPENR {
...
func (p *Periph) SRAM2LPEN() RMAHB1LPENR {
	return RMAHB1LPENR{mmio.UM32{&p.AHB1LPENR.U32, uint32(SRAM2LPEN)}}
}

func (p *Periph) BKPSRAMLPEN() RMAHB1LPENR {
...
func (p *Periph) DCMILPEN() RMAHB2LPENR {
	return RMAHB2LPENR{mmio.UM32{&p.AHB2LPENR.U32, uint32(DCMILPEN)}}
}

func (p *Periph) CRYPLPEN() RMAHB2LPENR {
...
func (p *Periph) FSMCLPEN() RMAHB3LPENR {
...
func (p *Periph) UART4LPEN() RMAPB1LPENR {
	return RMAPB1LPENR{mmio.UM32{&p.APB1LPENR.U32, uint32(UART4LPEN)}}
}

func (p *Periph) UART5LPEN() RMAPB1LPENR {
...
func (p *Periph) DACLPEN() RMAPB1LPENR {
...
func (p *Periph) ADC2LPEN() RMAPB2LPENR {
	return RMAPB2LPENR{mmio.UM32{&p.APB2LPENR.U32, uint32(ADC2LPEN)}}
}

func (p *Periph) ADC3LPEN() RMAPB2LPENR {
...
func (p *Periph) PLLI2SN0() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SN0)}}
}

func (p *Periph) PLLI2SN1() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SN1)}}
}

func (p *Periph) PLLI2SN2() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SN2)}}
}

func (p *Periph) PLLI2SN3() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SN3)}}
}

func (p *Periph) PLLI2SN4() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SN4)}}
}

func (p *Periph) PLLI2SN5() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SN5)}}
}

func (p *Periph) PLLI2SN6() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SN6)}}
}

func (p *Periph) PLLI2SN7() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SN7)}}
}

func (p *Periph) PLLI2SN8() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SN8)}}
}

func (p *Periph) PLLI2SR0() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SR0)}}
}

func (p *Periph) PLLI2SR1() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SR1)}}
}

func (p *Periph) PLLI2SR2() RMPLLI2SCFGR {
	return RMPLLI2SCFGR{mmio.UM32{&p.PLLI2SCFGR.U32, uint32(PLLI2SR2)}}
}

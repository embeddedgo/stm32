...
func UART7RST_(p *Periph) mmio.RM32[APB1RSTR] {
	return mmio.RM32[APB1RSTR]{R: &p.APB1RSTR, Mask: UART7RST}
}
func UART8RST_(p *Periph) mmio.RM32[APB1RSTR] {
	return mmio.RM32[APB1RSTR]{R: &p.APB1RSTR, Mask: UART8RST}
}
...
func SPI6RST_(p *Periph) mmio.RM32[APB2RSTR] {
	return mmio.RM32[APB2RSTR]{R: &p.APB2RSTR, Mask: SPI6RST}
}
...
func UART7EN_(p *Periph) mmio.RM32[APB1ENR] { return mmio.RM32[APB1ENR]{R: &p.APB1ENR, Mask: UART7EN} }
func UART8EN_(p *Periph) mmio.RM32[APB1ENR] { return mmio.RM32[APB1ENR]{R: &p.APB1ENR, Mask: UART8EN} }
...
func SPI6EN_(p *Periph) mmio.RM32[APB2ENR]  { return mmio.RM32[APB2ENR]{R: &p.APB2ENR, Mask: SPI6EN} }
